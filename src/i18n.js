  ...
  az: {
    translation: {
      ...
      sidebar: {
        ...
        "staff": "Heyət & Giriş",
        "security_logs": "Təhlükəsizlik Loqları",
        "venue_settings": "Məkan Tənzimləmələri",
        "analytics": "Analitika",
        "whats_new": "Yeniliklər",
        "help": "Kömək & Dəstək",

        "header_finance": "MALİYYƏ",
        "billing": "Ödənişlər",

        "header_operations": "ƏMƏLİYYATLAR",
        "live_orders": "Canlı Sifarişlər",
        "chat": "Çat / CRM",
        "reviews": "Rəylər / Əks-əlaqə",
        "menu": "Menyu İdarəetməsi",
        "table_layout": "Masa Düzümü",
        "floor_plan": "Vizual Zal Planı",

        "header_personal": "ŞƏXSİ",
        "profile_settings": "Profil Tənzimləmələri",

        "header_staff": "HEYƏT İNTERFEYSİ",
        "mobile_app": "Mobil Tətbiqi Aç",
        "staff_profile": "Heyət Profili",

        "badge_limits": "Limitlər",
        "badge_new": "Yeni",
        "badge_live": "Canlı",
        "badge_mobile": "Mobil"
      },
      ...
      chat: {
        ...
        "select_chat": "Söhbətə başlamaq üçün çat seçin"
      },
      reviews: {
        "title": "Qonaq Rəyləri",
        "managing": "İdarə olunur",
        "excellent": "Möhtəşəm",
        "based_on": "Cəmi",
        "reviews_count": "rəy əsasında",
        "reply": "Cavab ver",
        "hide": "Gizlət",
        "delete": "Sil",
        "no_reviews": "Rəy yoxdur"
      },
      menu: {
        ...
        "in_stock": "Stokda",
        "out_of_stock": "Bitib",
        "new_item": "Yeni Məhsul",
        "edit_item": "Məhsulu Redaktə Et",
        "upload_image": "Şəkil Yüklə",
        "item_name": "Məhsulun Adı",
        "price": "Qiymət",
        "category": "Kateqoriya",
        "description": "Təsvir / Tərkibi",
        "create_item": "Yarat",
        "save_changes": "Yadda Saxla",
        "confirm_delete": "Bu məhsulu silmək istədiyinizə əminsiniz?",
        "categories": {
          "all": "Hamısı",
          "main": "Əsas Yeməklər",
          "hot_dishes": "İsti Yeməklər",
          "cold_dishes": "Soyuq Qəlyanaltılar",
          "soups": "Şorbalar",
          "drinks": "İçkilər",
          "desserts": "Desertlər"
        }
      ...
      settings: {
        title: "Tənzimləmələr",
        subtitle: "Şəxsi profilinizi və seçimlərinizi idarə edin.",
        tab_account: "Hesab",
        tab_security: "Təhlükəsizlik",
        tab_notifications: "Bildirişlər",
        profile_details: "Profil Məlumatları",
        upload_photo: "Şəkil Yüklə",
        reset: "Sıfırla",
        allowed_files: "İcazə verilir: JPG, GIF və ya PNG. Maks 800K.",
        firstname: "Ad",
        lastname: "Soyad",
        email: "Email",
        role: "Rol",
        ...
        two_factor: "İki Mərhələli Təsdiqləmə",
        enable_2fa: "2FA Aktivləşdir",
        secure_account: "Hesabınızı OTP ilə qoruyun.",
        notifications_title: "Əməliyyat Bildirişləri",
        new_orders: "Yeni Sifarişlər / Rezervasiyalar",
        new_orders_desc: "Qonaq masa sifariş edəndə dərhal bildiriş alın.",
        waiter_call: "Ofisiant Çağırışı",
        waiter_call_desc: "Qonaq QR kodu skan edib çağırdıqda xəbər tutun.",
        bot_offline: "Bot Offline Xəbərdarlığı",
        bot_offline_desc: "n8n bağlantısı kəsildikdə kritik xəbərdarlıq.",
        cancel: "Ləğv et",
        save_changes: "Yadda Saxla"
      },
      tables: {
        "title": "Zal Sxemi",
        "new_zone": "Yeni Zona",
        "add_table": "Masa Əlavə Et",
        "zone_name": "Zona Adı",
        "table_number": "Masa Nömrəsi (məs: T-5)",
        "seats": "Yer Sayı",
        "shape": "Forma",
        "shape_square": "Kvadrat",
        "shape_circle": "Dairəvi",
        "shape_rectangle": "Düzbucaqlı",
        "no_tables": "Bu zonada hələ masa yoxdur.",
        "confirm_delete": "Masanı silmək istədiyinizə əminsiniz?",
        "status_available": "Sərbəst",
        "status_occupied": "Məşğul",
  ...
  ru: {
    translation: {
      ...
      sidebar: {
        ...
        "venue_settings": "Настройки Заведения",
        "analytics": "Аналитика",
        "whats_new": "Что Нового",
        "help": "Помощь и Поддержка",

        "header_finance": "ФИНАНСЫ",
        "billing": "Биллинг",

        "header_operations": "ОПЕРАЦИИ",
        "live_orders": "Живые Заказы",
        "chat": "Чат / CRM",
        "reviews": "Отзывы",
        "menu": "Управление Меню",
        "table_layout": "Схема Столов",
        "floor_plan": "Визуальный План",

        "header_personal": "ЛИЧНОЕ",
        "profile_settings": "Настройки Профиля",

        "header_staff": "ИНТЕРФЕЙС ПЕРСОНАЛА",
        "mobile_app": "Открыть Моб. Приложение",
      ...
      settings: {
        title: "Настройки",
        subtitle: "Управление личным профилем и предпочтениями.",
        tab_account: "Аккаунт",
        ...
        reset: "Сброс",
        allowed_files: "Допустимые форматы JPG, GIF или PNG. Макс 800K.",
        firstname: "Имя",
        lastname: "Фамилия",
        email: "Email",
        role: "Роль",
        ...
        secure_account: "Защитите аккаунт с помощью OTP.",
        notifications_title: "Операционные Оповещения",
        new_orders: "Новые Заказы / Бронь",
        new_orders_desc: "Получайте уведомления сразу, когда гость бронирует стол.",
        waiter_call: "Вызов Официанта",
        waiter_call_desc: "Оповещение, когда гость сканирует QR.",
        bot_offline: "Бот Оффлайн",
        bot_offline_desc: "Критическое оповещение при потере связи с n8n.",
        cancel: "Отмена",
      ...
      tables: {
        ...
        "table_number": "Номер Стола (напр. T-5)",
        "seats": "Мест",
        "shape": "Форма",
        "shape_square": "Квадрат",
        "shape_circle": "Круг",
        "shape_rectangle": "Прямоугольник",
        "no_tables": "В этой зоне пока нет столов.",
        "confirm_delete": "Вы уверены, что хотите удалить этот стол?",
        "status_available": "Свободен",
        "status_occupied": "Занят",
        "status_reserved": "Бронь"
      },
      floor_plan: {
        "title": "Визуальный План",
        "edit": "Ред.",
        "no_map": "Карта не загружена",
        "switch_desc": "Переключитесь в режим редактирования",
        "upload_title": "Загрузить План",
        "upload_desc": "Нажмите, чтобы выбрать файл",
        "remove_map": "Удалить Карту",
        "add_items": "ДОБАВИТЬ ЭЛЕМЕНТЫ",
        "available_tables": "Доступные Столы",
        "objects": "Объекты",
        "wall": "Стена / Перегородка",
        "decor": "Декор / Объект",
