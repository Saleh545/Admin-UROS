...
import { 
  ...
  InputAdornment, Menu, MenuItem, useTheme, useMediaQuery, Paper, IconButton 
} from '@mui/material';
import { 
    ...
    <Box sx={{ width: '100%', maxWidth: '100vw', overflowX: 'hidden', boxSizing: 'border-box', p: { xs: 1, md: 3 }, pb: { xs: 5, md: 5 } }}>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} lg={8} sx={{ minWidth: 0 }}>
          <Card sx={{ boxShadow: 3, borderRadius: '12px', height: '100%', bgcolor: '#2b2c40', color: '#fff', border: '1px solid rgba(255,255,255,0.05)' }}>
            <CardContent sx={{ p: 4 }}>
              ...
              <Box sx={{ display: 'flex', gap: 3, mb: 4, alignItems: 'flex-start' }}>
                <Box sx={{ width: 100, height: 100, bgcolor: '#32344a', borderRadius: 2, border: '1px solid rgba(255,255,255,0.1)' }} />
                <Box sx={{ pt: 1 }}>
                  <Button variant="contained" startIcon={<CloudUpload />} sx={{ bgcolor: '#4285F4', textTransform: 'none', fontWeight: 'bold', mb: 1 }}>
                    {t('venue.btn_upload')}
                  </Button>
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                ...
                <TextField 
                  ...
                  InputLabelProps={{ shrink: true, style: { color: 'rgba(255,255,255,0.7)' } }}
                  InputProps={{ 
                    startAdornment: <InputAdornment position="start"><Typography color="text.secondary" sx={{ bgcolor: 'rgba(255,255,255,0.05)', px: 1, py: 0.5, borderRadius: 1, fontSize: '0.85rem' }}>ur-os.az/r/</Typography></InputAdornment> 
                  }}
                  sx={{ '& .MuiOutlinedInput-root': { color: '#fff', '& fieldset': { borderColor: 'rgba(255,255,255,0.2)' } } }}
                />
                ...
                <Box>
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 1.5 }}>
                    ...
                    <Button size="small" startIcon={<MyLocation />} sx={{ textTransform: 'none', color: '#4285F4' }}>
                      {t('venue.pick_map')}
                    </Button>
                  </Box>
                  <Box sx={{ display: 'flex', gap: 2 }}>
                    <TextField 
                      fullWidth label={t('venue.label_lat')} name="lat" value={formData.lat} onChange={handleChange}
                      InputLabelProps={{ shrink: true, style: { color: 'rgba(255,255,255,0.7)' } }}
                      sx={{ '& .MuiOutlinedInput-root': { color: '#fff', '& fieldset': { borderColor: 'rgba(255,255,255,0.2)' } } }}
                    />
                    <TextField 
                      fullWidth label={t('venue.label_lng')} name="lng" value={formData.lng} onChange={handleChange}
                      InputLabelProps={{ shrink: true, style: { color: 'rgba(255,255,255,0.7)' } }}
                      sx={{ '& .MuiOutlinedInput-root': { color: '#fff', '& fieldset': { borderColor: 'rgba(255,255,255,0.2)' } } }}
                    />
                  </Box>
                ...
                <Box sx={{ display: 'flex', gap: 2 }}>
                  <TextField 
                    fullWidth label={t('venue.label_phone')} name="phone" value={formData.phone} onChange={handleChange}
                    InputLabelProps={{ shrink: true, style: { color: 'rgba(255,255,255,0.7)' } }}
                    InputProps={{ startAdornment: <InputAdornment position="start"><Phone sx={{ color: 'rgba(255,255,255,0.5)' }} /></InputAdornment> }}
                    sx={{ '& .MuiOutlinedInput-root': { color: '#fff', '& fieldset': { borderColor: 'rgba(255,255,255,0.2)' } } }}
                  />
                  <TextField 
                    fullWidth label={t('venue.label_wifi')} name="wifi" value={formData.wifi} onChange={handleChange}
                    InputLabelProps={{ shrink: true, style: { color: 'rgba(255,255,255,0.7)' } }}
                    InputProps={{ startAdornment: <InputAdornment position="start"><Wifi sx={{ color: 'rgba(255,255,255,0.5)' }} /></InputAdornment> }}
                    sx={{ '& .MuiOutlinedInput-root': { color: '#fff', '& fieldset': { borderColor: 'rgba(255,255,255,0.2)' } } }}
                  />
                </Box>
        ...
        <Grid item xs={12} lg={4} sx={{ minWidth: 0 }}>
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
            ...
            {/* QR Center */}
            <Card sx={{ boxShadow: 3, borderRadius: '12px', bgcolor: '#2b2c40', color: '#fff', border: '1px solid rgba(255,255,255,0.05)' }}>
              <CardContent sx={{ p: 4, textAlign: 'center' }}>
                ...
                <Box sx={{ bgcolor: '#fff', p: 1.5, borderRadius: 2, display: 'inline-block', mb: 3 }}>
                  <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=Example" alt="QR" style={{ width: 140, height: 140 }} />
                </Box>
                
                <Button fullWidth variant="contained" startIcon={<Download />} sx={{ bgcolor: '#4285F4', fontWeight: 'bold', textTransform: 'none', mb: 2 }}>
            ...
            <Card sx={{ boxShadow: 3, borderRadius: '12px', bgcolor: '#2b2c40', color: '#fff', border: '1px solid rgba(255,255,255,0.05)' }}>
              <CardContent sx={{ p: 3 }}>
                ...
                <Box sx={{ display: 'flex', gap: 2 }}>
                  <TextField 
                    fullWidth label={t('venue.label_currency')} name="currency" value={formData.currency} onChange={handleChange}
                    InputLabelProps={{ shrink: true, style: { color: 'rgba(255,255,255,0.7)' } }}
                    sx={{ '& .MuiOutlinedInput-root': { color: '#fff', '& fieldset': { borderColor: 'rgba(255,255,255,0.2)' } } }}
                  />
                  <TextField 
                    fullWidth label={t('venue.label_service')} name="serviceFee" value={formData.serviceFee} onChange={handleChange}
                    InputLabelProps={{ shrink: true, style: { color: 'rgba(255,255,255,0.7)' } }}
                    InputProps={{ endAdornment: <InputAdornment position="end"><Percent fontSize="small" sx={{ color: 'rgba(255,255,255,0.5)' }} /></InputAdornment> }}
                    sx={{ '& .MuiOutlinedInput-root': { color: '#fff', '& fieldset': { borderColor: 'rgba(255,255,255,0.2)' } } }}
                  />
                </Box>
              </CardContent>
            ...
            <Card sx={{ boxShadow: 3, borderRadius: '12px', bgcolor: '#2b2c40', color: '#fff', border: '1px solid rgba(255,255,255,0.05)' }}>
              <CardContent sx={{ p: 3 }}>
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2.5 }}>
                  <TextField 
                    fullWidth label={t('venue.label_insta')} name="insta" value={formData.insta} onChange={handleChange}
                    InputLabelProps={{ shrink: true, style: { color: 'rgba(255,255,255,0.7)' } }}
                    InputProps={{ startAdornment: <InputAdornment position="start"><Instagram sx={{ color: 'rgba(255,255,255,0.5)' }} /></InputAdornment> }}
                    sx={{ '& .MuiOutlinedInput-root': { color: '#fff', '& fieldset': { borderColor: 'rgba(255,255,255,0.2)' } } }}
                  />
                  <TextField 
                    fullWidth label={t('venue.label_whatsapp')} name="whatsapp" value={formData.whatsapp} onChange={handleChange}
                    InputLabelProps={{ shrink: true, style: { color: 'rgba(255,255,255,0.7)' } }}
                    InputProps={{ startAdornment: <InputAdornment position="start"><WhatsApp sx={{ color: 'rgba(255,255,255,0.5)' }} /></InputAdornment> }}
                    sx={{ '& .MuiOutlinedInput-root': { color: '#fff', '& fieldset': { borderColor: 'rgba(255,255,255,0.2)' } } }}
                  />
                </Box>
              </CardContent>
            ...
            {/* Bu düymə sağ sütunun ən sonunda, sağa hizalı olacaq */}
            <Box sx={{ display: 'flex', justifyContent: { xs: 'center', md: 'flex-end' }, mt: 1 }}>
              <Button 
                ...
                sx={{ 
                  ...
                  fontSize: '1rem', 
                  borderRadius: 2,
                  width: { xs: '100%', md: 'auto' } // Mobildə tam en, PC-də normal
                }}
              >
                {t('venue.btn_save')}
              </Button>
